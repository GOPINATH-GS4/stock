...
exports.FAILURE = {
    http_status: 500,
    status: 500,
    message: 'failure - something went wrong in the status'
}
exports.E1000 = {
    http_status: 200,
    status: 1000,
...
exports.E1002 = {
    http_status: 200,
    status: 1002,
    message: 'more than one result found - expecting just one'
}
exports.E1003 = {
    http_status: 200,
    status: 1003,
    message: 'one result found - expecting more than one'
}
exports.E1004 = {
    http_status: 200,
    status: 1004,
    message: 'one result found - expecting no result'
}
