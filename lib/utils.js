...
var utils = function(log) {
 ...
 this.writeResponse = function(req, res, response) {
    ...
    res.writeHead(status, {
      'Content-Length': JSON.stringify(returnResponse).length,
      'Content-Type': 'application/json', 
      'ClientToken' : _.has(req.headers, 'clienttoken') ? req.headers.clienttoken : null
    });
 ...
 this.makeLogData = function(level, type, sessionId, id, idType, method, action, value, msg) {
   ...
   return {level: level, type: type, sessionId: sessionId,  id: id, idType: idType, method: method, action: action, value: value, msg: msg, timestamp: new Date()};
 }
}
exports.utils = utils;
