...
var utils = function(request, log) {
    ...
    this.isLoggedIn = function(req, res, callback) {
        ...
        _.each(cookies, function(cookie) {
            ...
            if (name === 'ctcToken') {
                ctcToken.exists = true;
                ctcToken.ctcToken = value;
            }
        });
        ...
        if (ctcToken.exists) {
            ...
            payLoad.headers.userToken = ctcToken.ctcToken;
    ...
    this.getCookie = function(req, cookieName) {
        ...
        if (typeof res.headers.cookies === 'undefined' || res.headers.cookies === null) return cookieToken;
        var cookies = req.headers.cookie.split(';');
        _.each(cookies, function(cookie) {
            ...
            if (name === cookieName) {
                cookieToken.exists = true;
                cookieToken.value = value;
            }
        });
        console.log('Returining for cookieName ' + cookieName + u.inspect(cookieToken));
        return cookieToken;
    }
