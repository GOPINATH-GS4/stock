...
module.exports = function(app, stock, constants, utils, log) {
    ...
    var collections = function(req, res) {
        ...
        res.render('collections' , {data: [{'nctid':12345}, {'description': 'Cancer'} , {'trt_groups': [{'trt1':'treatment1'}, 
                                            {'trt2': 'treatment2'}, {'placebo': 'placebo'}]},
                                            {'trt_assignment': [{'trt1': 20}, {'trt2': 30}, {'placebo':10}]}]});
